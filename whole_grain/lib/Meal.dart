			    ...
			    child: Column(
			    	children: <Widget>[
							Align(
									...
									child: Text(offstage ? "No whole grain food added!" :
			    			"Whole grain food you have taken: ")),
							SizedBox(
								height: 8,
							),
							Offstage(
								...
								child: StreamBuilder(
									stream: Firestore.instance.collection(widget.mealName.toLowerCase()).where
										("token", isEqualTo: token).where("date", isEqualTo: widget.date).snapshots(),
